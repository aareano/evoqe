 ...
 */
public class JamboreeInfoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static enum Card {
        DETAILS {
            ...
            public ViewHolder_1 getViewHolder(ViewGroup viewGroup) {
                ...
                View v = LayoutInflater.from(viewGroup.getContext())
                        .inflate(R.layout.card_jamboree_info_1, viewGroup, false);
        ...
        ACTIONS {
            ...
            public ViewHolder_2 getViewHolder(ViewGroup viewGroup) {
                ...
                View v = LayoutInflater.from(viewGroup.getContext())
                        .inflate(R.layout.card_jamboree_info_2, viewGroup, false);
    ...
    public JamboreeInfoAdapter(ParseProxyObject jamboree, Context context) {
        mJamboree = jamboree;
        mContext = context;
    ...
    private static void addEventToCalendar() {
            ...
            startTime.setTimeInMillis(mJamboree.getDate("startTime").getTime());
            Calendar endTime = Calendar.getInstance();
            endTime.setTimeInMillis(mJamboree.getDate("endTime").getTime());
